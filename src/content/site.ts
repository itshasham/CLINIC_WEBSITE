export const clinic = {
  ...
  phoneHref: 'tel:+924237182024',
  alternatePhone: '+92-42-37182025',
  alternatePhoneHref: 'tel:+924237182025',
  mobile: '+92-321-6771064',
  mobileHref: 'tel:+923216771064',
  mapHref:
...
export const homeStats = [
  { value: 'DHA', label: 'Phase 5 clinic address in Lahore' },
  { value: '01', label: 'Consultation-first care before any treatment plan' },
  { value: '05', label: 'Core treatment pillars across skin, laser, hair, and cosmetic care' },
];
...
export const patientJourney = [
  ...
  },
  {
    step: '04',
    title: 'Aftercare',
    text: 'Support the finish with guidance that protects recovery, glow, and long-term maintenance.',
  },
];
...
export const testimonials = [
  {
    quote:
      'The clinic experience felt quiet and premium, and the consultation explained what made sense for my skin before anything else.',
    name: 'Ayesha R.',
  },
  {
    quote:
      'It felt reassuring rather than salesy. I liked that the plan was structured around subtle improvement, not dramatic promises.',
    name: 'Maha K.',
  },
  {
    quote:
      'Everything from the environment to the aftercare explanation felt polished and well thought through.',
    name: 'Sara H.',
  },
  {
    quote:
      'The conversation was clear, the options felt realistic, and the clinic atmosphere genuinely matched a luxury standard.',
    name: 'Hina M.',
  },
];
...
export const contactHighlights = [
  'Consultations and general treatment questions',
  'Laser, skin, hair, and cosmetic guidance',
  'Aftercare support and clinic visit coordination',
];
